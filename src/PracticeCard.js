        ...
        >
          <View ref={iconColRef} style={{ alignItems: 'center' }}>
            <View style={{ position: 'relative' }}>
              ...
              <Text style={{ position: 'absolute', top: 1, right: 1, fontFamily: FONT.display, fontSize: 13, lineHeight: 13, color: cat.color, textShadowColor: 'rgba(0,0,0,0.9)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 }}>{p.level || 1}</Text>
            </View>
